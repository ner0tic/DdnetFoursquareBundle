...
namespace Ddnet\FoursquareBundle\Security\Authentication\Token;

use Symfony\Component\Security\Core\Authentication\Token\AbstractToken;

class FoursquareUserToken extends AbstractToken {
  private $providerKey;
  ...
  public function getProviderKey() { return $this->providerKey; }
